...
*/
    ...
    public class Hitbox
    {
        ...
        private void increaseBodyParts()
        {
            ...
            for (int i = 0; i < bodyParts.GetLength(0); i++)
            {
                bodyParts2[i] = bodyParts[i];

            }

            bodyParts = bodyParts2;
        }
        ...
        {
            return getyMaxLocation() - getyMinLocation();
        }

        public double getHitboxLengthX()
        {
            return getxMaxLocation() - getxMinLocation();
        }
        ...
        {
            return (getxMaxLocation() + getxMinLocation()) / 2;
        }

        public double getHitboxCenterY()
        {
            return (getyMaxLocation() + getyMinLocation()) / 2;
        }

        public double getHitboxCenterZ()
        {
            return (getzMaxLocation() + getzMinLocation()) / 2;
        }
        ...
        public bool VitalOrganDamaged()
        {
            ...
            for (int i = 0; i < getBodyParts().Length; i++)
            {

                if (getBodyParts()[i] != null && getBodyParts()[i].getWounds() != null)
                {
